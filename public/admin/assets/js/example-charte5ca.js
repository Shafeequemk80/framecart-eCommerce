    ...
    $selector.each(function () {
      for (
        ...
        chart_data.push({
          ...
          barPercentage: NioApp.State.asMobile ? 0.95 : 0.75,
          categoryPercentage: NioApp.State.asMobile ? 0.95 : 0.75,
        });
        ...
        options: {
          ...
          scales: {
            y: {
              ...
              ticks: { beginAtZero: !0, font: { size: 12 }, color: "#9eaecf" },
              grid: {
      ...
      datasets: [
        {
          label: "Total Received",
          color: "#9d72ff",
          background: NioApp.hexRGB("#9d72ff", 0.4),
